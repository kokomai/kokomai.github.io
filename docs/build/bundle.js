    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = space();
    			p1 = element("p");
    			p1.textContent = "Catholic University Korea :: Psycology & Sociology";
    			t9 = space();
    			p2 = element("p");
    			...
    			add_location(p2, file$3, 38, 3, 861);
    			attr_dev(p3, "class", "desc svelte-dkcb49");
    			add_location(p3, file$3, 39, 3, 897);
    			attr_dev(div0, "class", "column");
    			add_location(div0, file$3, 35, 2, 724);
    			add_location(br, file$3, 41, 2, 938);
    			attr_dev(h21, "class", "subtitle");
    			add_location(h21, file$3, 42, 2, 946);
    			attr_dev(hr2, "class", "content-divider");
    			add_location(hr2, file$3, 43, 2, 984);
    			attr_dev(p4, "class", "year svelte-dkcb49");
    			add_location(p4, file$3, 45, 3, 1041);
    			attr_dev(p5, "class", "project-name svelte-dkcb49");
    			add_location(p5, file$3, 46, 3, 1084);
    			attr_dev(p6, "class", "desc svelte-dkcb49");
    			add_location(p6, file$3, 47, 3, 1133);
    			attr_dev(p7, "class", "year svelte-dkcb49");
    			add_location(p7, file$3, 48, 3, 1171);
    			attr_dev(p8, "class", "project-name svelte-dkcb49");
    			add_location(p8, file$3, 49, 3, 1214);
    			attr_dev(p9, "class", "desc svelte-dkcb49");
    			add_location(p9, file$3, 50, 3, 1276);
    			attr_dev(div1, "class", "column");
    			add_location(div1, file$3, 44, 2, 1016);
