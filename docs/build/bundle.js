    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 31, 2, 602);
    			add_location(hr0, file$3, 32, 2, 648);
    			attr_dev(h20, "class", "subtitle");
    			add_location(h20, file$3, 33, 2, 656);
    			attr_dev(hr1, "class", "content-divider");
    			add_location(hr1, file$3, 34, 2, 692);
    			attr_dev(p0, "class", "year svelte-dkcb49");
    			add_location(p0, file$3, 36, 3, 749);
    			attr_dev(p1, "class", "desc svelte-dkcb49");
    			add_location(p1, file$3, 37, 3, 786);
    			attr_dev(p2, "class", "year svelte-dkcb49");
    			add_location(p2, file$3, 38, 3, 864);
    			attr_dev(p3, "class", "desc svelte-dkcb49");
    			add_location(p3, file$3, 39, 3, 900);
    			attr_dev(div0, "class", "column");
    			add_location(div0, file$3, 35, 2, 724);
    			add_location(br, file$3, 41, 2, 941);
    			attr_dev(h21, "class", "subtitle");
    			add_location(h21, file$3, 42, 2, 949);
    			attr_dev(hr2, "class", "content-divider");
    			add_location(hr2, file$3, 43, 2, 987);
    			attr_dev(p4, "class", "year svelte-dkcb49");
    			add_location(p4, file$3, 45, 3, 1044);
    			attr_dev(p5, "class", "project-name svelte-dkcb49");
    			add_location(p5, file$3, 46, 3, 1087);
    			attr_dev(p6, "class", "desc svelte-dkcb49");
    			add_location(p6, file$3, 47, 3, 1136);
    			attr_dev(p7, "class", "year svelte-dkcb49");
    			add_location(p7, file$3, 51, 3, 1282);
    			attr_dev(p8, "class", "project-name svelte-dkcb49");
    			add_location(p8, file$3, 52, 3, 1325);
    			attr_dev(p9, "class", "desc svelte-dkcb49");
    			add_location(p9, file$3, 53, 3, 1387);
    			attr_dev(p10, "class", "year svelte-dkcb49");
    			add_location(p10, file$3, 57, 3, 1695);
    			attr_dev(p11, "class", "project-name svelte-dkcb49");
    			add_location(p11, file$3, 58, 3, 1738);
    			attr_dev(p12, "class", "desc svelte-dkcb49");
    			add_location(p12, file$3, 59, 3, 1794);
    			attr_dev(p13, "class", "year svelte-dkcb49");
    			add_location(p13, file$3, 64, 3, 1998);
    			attr_dev(p14, "class", "project-name svelte-dkcb49");
    			add_location(p14, file$3, 65, 3, 2041);
    			attr_dev(p15, "class", "desc svelte-dkcb49");
    			add_location(p15, file$3, 66, 3, 2093);
    			attr_dev(p16, "class", "year svelte-dkcb49");
    			add_location(p16, file$3, 70, 3, 2277);
    			attr_dev(p17, "class", "project-name svelte-dkcb49");
    			add_location(p17, file$3, 71, 3, 2320);
    			attr_dev(p18, "class", "desc svelte-dkcb49");
    			add_location(p18, file$3, 72, 3, 2376);
    			attr_dev(div1, "class", "column");
    			add_location(div1, file$3, 44, 2, 1019);
    			attr_dev(div2, "class", "column is-10 is-offset-3");
    			add_location(div2, file$3, 30, 2, 560);
    			attr_dev(div3, "class", "column");
    			add_location(div3, file$3, 29, 1, 536);
    			attr_dev(div4, "class", "container");
    			add_location(div4, file$3, 28, 1, 510);
    			attr_dev(div5, "class", "hero-body");
    			add_location(div5, file$3, 27, 0, 484);
    			attr_dev(section, "id", "parallax-1");
    			attr_dev(section, "class", "hero is-large ");
    			add_location(section, file$3, 26, 0, 434);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
